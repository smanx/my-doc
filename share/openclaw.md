...
```bash
docker run -d --name openclaw -p 18789:18789 -v openclaw:/root -e OPENCLAW_GATEWAY_TOKEN=token smanx/openclaw
```
...
| 配置项 | 说明 |
|--------|------|
| 镜像名称 | `smanx/openclaw:2026.1.30`  (建议指定版本，官方更新太频繁可能导致默认的配置失效)|
